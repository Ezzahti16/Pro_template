...
class TemplateSettings(models.Model):
    ...
    template_inv = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates.INVOICE_%_document' )]",
        required=False)
    template_so = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates.SO_%_document' )]",
        required=False)
    ...
    template_po = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates.PO_%_document' )]",
        required=False)
    ...
    template_rfq = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates.RFQ_%_document' )]",
        required=False)
    ...
    template_dn = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates.DN_%_document' )]",
        required=False)
    ...
    template_pk = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates.PICK_%_document' )]",
        required=False)
...
''',
    ...
    def wm_eval(self, doc, time, user, company):
        ...
        localdict = dict(watermark=None,
                         ...
                         company=company)
        try:
            safe_eval(self.watermark, localdict, mode='exec')
